...
interface IGMXRewardRouterV2 {
    ...
    // function mintAndStakeGlp(address _token, uint256 _amount, uint256 _minUsdg, uint256 _minGlp, bytes[] calldata _pythUpdateData) external payable  returns (uint256);
